...
{
	for ( UFMGInvSysItemCore* AddedItemCore : Added )
	{
		AddNewItemClicker( AddedItemCore );
	}

	for ( UFMGInvSysItemCore* RemovedItemCore : Removed )
	{
		RemoveItemClicker( RemovedItemCore );
	}
}
